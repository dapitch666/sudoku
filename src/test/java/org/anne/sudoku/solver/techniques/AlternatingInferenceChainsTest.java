...
class AlternatingInferenceChainsTest {
    ...
    void alternatingInferenceChainsTest1() {
        ...
        runTest(puzzle, solved, new String[]{"Alternating Inference Chains"}, new int[]{1}, true);
    }
    ...
    void alternatingInferenceChainsTest3() {
        ...
        runTest(puzzle, solved, new String[]{"Alternating Inference Chains"}, new int[]{5}, true);
    }
    ...
    void alternatingInferenceChainsTest4() {
        ...
        runTest(puzzle, solved, new String[]{"Alternating Inference Chains"}, new int[]{3}, true);
    }
    ...
    void alternatingInferenceChainsTest5() {
        ...
        runTest(puzzle, solved, new String[]{"Alternating Inference Chains"}, new int[]{2}, true);
    }
    ...
    void alternatingInferenceChainsTest8() {
        ...
        runTest(puzzle, solved, new String[]{"Alternating Inference Chains"}, new int[]{12}, true);
    }
    ...
    void alternatingInferenceChainsTest11() {
        ...
        runTest(puzzle, solved, new String[]{"Alternating Inference Chains"}, new int[]{9}, true);
    }
