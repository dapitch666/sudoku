...
class XYChainsTest {
    ...
    void xyChainsTest1() {
        ...
        runTest(puzzle, solved, new String[]{"XY-Chains"}, new int[]{3}, false);
    }
    ...
    void xyChainsTest2() {
        ...
        runTest(puzzle, solved, new String[]{"XY-Chains"}, new int[]{2}, false);
    }
    ...
    void xyChainsTest5() {
        ...
        runTest(puzzle, solved, new String[]{"XY-Chains"}, new int[]{9}, false);
    }
}