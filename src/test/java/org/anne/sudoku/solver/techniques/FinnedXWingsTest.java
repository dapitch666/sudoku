...
class FinnedXWingsTest {
    ...
    void finnedXWingsTest1() {
        ...
        String solved = "754..8.3.836......19235.84.2459........745...9....3654.2981..........91..1.5....8";
        // String solved = "754198236836472591192356847245961783368745129971283654429817365587634912613529478";
        // runTest(puzzle, solved, new String[]{"Finned X-Wings", "Finned Sword-Fish"}, new int[]{1, 1}, true);
        runTest(puzzle, solved, new String[]{"Finned X-Wings"}, new int[]{1}, true);
    }

    @Disabled("Works only with Grouped X-Cycles disabled")
    @Test
    void finnedXWingsTest2() {
        ...
        runTest(puzzle, solved, new String[]{"Finned X-Wings"}, new int[]{2}, true);
    }
}